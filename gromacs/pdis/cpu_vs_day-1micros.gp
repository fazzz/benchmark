...
set output "cpu_vs_day-1micros.eps"
...
p for [i=1:9] \
    sprintf("gromacs-2023/%s/%s_%s",d,f,pdis[i]) u 1:2 w p pt 7 ps 1.0 lc rgb color[i] \
    title sprintf("%s",pdis[i]), \
  for [i=1:9] \
    sprintf("gromacs-2023/%s/%s_%s",d,f,pdis[i]) u 1:2 w l lt 1 lc rgb color[i] \
    notitle, \
  for [i=1:9] \
    sprintf("gromacs-2022/%s/%s_%s",d,f,pdis[i]) u 1:2 w p pt 7 ps 1.0 lc rgb color[i] \
    notitle, \
  for [i=1:9] \
    sprintf("gromacs-2022/%s/%s_%s",d,f,pdis[i]) u 1:2 w l lt 0 lc rgb color[i] notitle
